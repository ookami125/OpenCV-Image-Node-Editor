...
struct ImageAddNode : Node {

    GLTextureData texture;
    float scale = 100.0f;

    static Node* Create() {
        ImageAddNode* node = new ImageAddNode();
        node->Title = "Image Add Node";
...
REGISTER_NODE("Image>Image Add Node", ImageAddNode);